...
/**
 * Player-only criterion with no extra conditions. Datapack JSON is
 * {@code { "trigger": "create_originium_industry:dust_exposure" }} (or the
 * other registered trigger ids).
 */
